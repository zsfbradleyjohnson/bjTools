                                    ...
                                    blue:(CGFloat)blue
{
    ...
    UIImage *image = [self qrCodeImageWithContent:infomation codeImageSize:size red:red green:green blue:blue];
    //有 logo 则绘制 logo
    if (logo != nil) {
        UIGraphicsBeginImageContext(image.size);
        [image drawInRect:CGRectMake(0, 0, image.size.width, image.size.height)];
        
        CGRect rect = CGRectMake(size*3.0/8.0,size*3.0/8.0,size/4.0,size/4.0);
